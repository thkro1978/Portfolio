...
const About = () => {
  ...
  const skills = ['Human-Centered Design', 'User Research', 'Product Thinking', 'Interaction Design', 'UX Auditing & QA', 'UX Leadership', 'Figma' , 'Miro' , 'Confluence' , 'Jira'];
        ...
        <StyledText>
          <div>
            <p>
              ...
              first Mac computer, learning the foundations of good design, programming, interaction and animation.
            </p>
            ...
            <p>Here are a few of my skills and technologies I'm using:</p>
          </div>
